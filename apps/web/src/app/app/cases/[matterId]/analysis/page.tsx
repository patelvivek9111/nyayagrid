        ...
        {!selected ? (
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-ink/55">
              Diffs are deterministic. AI summary is a proposal — verify against the change list.
            </p>
            {selected.comparison.summary ? (
              <p className="whitespace-pre-wrap text-sm text-ink/80">{selected.comparison.summary}</p>
            ) : null}
            {selected.summaryScore?.unsupportedClaims?.length ? (
              <div className="rounded border border-amber-700/25 bg-amber-50/60 px-3 py-2 text-xs">
                <p className="font-semibold">Flagged summary claims</p>
