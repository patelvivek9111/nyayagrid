  ...
  "candidates": [
    {
      ...
      "explanation": "The first source states that the February CAM package was emailed on February 28, 2025, while the second source claims it was uploaded to the portal on March 3, 2025, with no earlier transmission noted. These two statements cannot both be true regarding the timing of the transmission.",
      "confidence": "high",
      "sideA": {
        "chunkIds": [
      ...
      "sideB": {
        ...
        "summary": "The February CAM package was uploaded to the portal on March 3, 2025, with no earlier transmission seen."
      }
    }
  ]
}
