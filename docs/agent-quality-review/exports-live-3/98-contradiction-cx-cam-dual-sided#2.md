  ...
  "candidates": [
    {
      ...
      "explanation": "One source states that the February CAM package was emailed on February 28, 2025, while another source claims it was uploaded to the portal on March 3, 2025, with no earlier transmission noted.",
      "confidence": "high",
      "sideA": {
        "chunkIds": [
