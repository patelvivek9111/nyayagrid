...
## Output
The indemnity obligation is only a partial picture, as it specifies that Tenant shall indemnify Landlord only for third-party claims arising from Tenant's negligence, and does not clarify the full extent of the indemnity obligations or any other conditions that may apply.
## Cited sources
