# golden-adv-combine-indemnity-and-rent#3
- Workflow: case_qa
...
## Output
The monthly base rent is $4,000. The amendment changes the indemnity obligation by stating that Tenant shall indemnify Landlord only for third-party claims arising from Tenant's negligence, and not for Landlord's sole negligence.
## Cited sources
