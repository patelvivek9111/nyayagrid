...
## Output
The indemnity obligation is only a partial picture, as it specifies that Tenant shall indemnify Landlord only for third-party claims arising from Tenant's negligence, and not for Landlord's sole negligence, but does not provide details on the full scope or limitations of the indemnity obligation.
## Cited sources
