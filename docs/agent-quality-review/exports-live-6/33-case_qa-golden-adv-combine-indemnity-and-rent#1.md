...
## Output
$4,000 Base Rent, and the amendment changes the indemnity obligation to require the Tenant to indemnify the Landlord only for third-party claims arising from Tenant's negligence, and not for Landlord's sole negligence.
## Cited sources
