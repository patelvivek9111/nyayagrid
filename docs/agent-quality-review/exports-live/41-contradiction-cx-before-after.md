  ...
  "candidates": [
    {
      ...
      "explanation": "There is a direct contradiction regarding the completion status of the work before the inspection. One source claims the work was completed, while another asserts it was still unfinished.",
      "confidence": "high",
      "sideA": {
        "chunkIds": [
