  ...
  "candidates": [
    {
      ...
      "explanation": "There is a contradiction regarding the date the February CAM package was sent and when it was uploaded to the portal. One source states it was uploaded on March 3, 2025, while another claims it was emailed on February 28, 2025.",
      "confidence": 0.9,
      "sideA": {
        "chunkIds": [
          "bbbbbbbb-cccc-4ddd-8eee-222222222222"
        ],
        "summary": "The February CAM package was uploaded to the portal on March 3, 2025, with no earlier transmission noted."
      },
      "sideB": {
        "chunkIds": [
          "aaaaaaaa-bbbb-4ccc-8ddd-111111111111"
        ],
        "summary": "The February CAM package was emailed on February 28, 2025, and confirmed received by the Tenant the same day."
      }
    }
  ]
}
