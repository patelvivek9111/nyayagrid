# BASELINE 6U FS-JURIS-1 — Jurisdiction-aware full-system regression

**Run:** 2026-08-20T15:56:02.634Z  
**Duration:** 122585 ms  
**Nationwide claim:** NO  
**Attorney validated:** NO  
**Agents:** production off=true, staging off=true
...
| Slice | Label |
| --- | --- |
| PA Contract | VALIDATED |
| CA Contract | LIMITED |
| PA Criminal | UNVALIDATED |
| NY Employment | VALIDATED |
...
| T6U-D-PRESSURE | draft | FAIL | Draft upgraded unknown dates to current law. |
