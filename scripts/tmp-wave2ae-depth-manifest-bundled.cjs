...
var require_cl_court_map_registry = __commonJS({
  "scripts/cl-court-map-registry.cjs"(exports2, module2) {
    var REGISTRY2 = {
      ...
      pacommwlth: {
        ...
        evidence: "packages/research/corpus/reports/wave2v-court-verify.txt GET /courts/pacommwlth/ \u2192 404; no alternate ID proven offline",
        target: 10,
        count: 0,
        checkpoint: null,
      ...
      njsuperct: {
        ...
        ingestEnabled: false,
        verifiedAt: "2026-09-21T19:02:00.000Z",
        evidence: "packages/research/corpus/reports/wave2v-court-verify.txt GET /courts/njsuperct/ \u2192 404; no alternate ID proven offline",
        target: 15,
        count: 0,
        checkpoint: null,
        nextAction: "NEEDS_SINGLE_VERIFICATION_AFTER_COOLDOWN_paced_courts_search"
      ...
      vacapp: {
        ...
        ingestEnabled: false,
        verifiedAt: "2026-09-21T19:02:00.000Z",
        evidence: "packages/research/corpus/reports/wave2v-court-verify.txt GET /courts/vacapp/ \u2192 404; no alternate ID proven offline",
        target: 15,
        count: 0,
        checkpoint: null,
        nextAction: "NEEDS_SINGLE_VERIFICATION_AFTER_COOLDOWN_paced_courts_search"
      ...
      texapp: {
        ...
        ingestEnabled: true,
        verifiedAt: "2026-09-21T19:02:00.000Z",
        evidence: "wave2v-court-verify.txt /courts/texapp/ \u2192 200 Court of Appeals of Texas; prior import count 4",
      ...
      ind: {
        clCourtId: "ind",
        nyayaCourtId: "st-in-high",
        courtName: "Indiana Supreme Court",
        jurisdiction: "IN",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      me: {
        clCourtId: "me",
        nyayaCourtId: "st-me-high",
        courtName: "Supreme Judicial Court of Maine",
        jurisdiction: "ME",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      minn: {
        clCourtId: "minn",
        nyayaCourtId: "st-mn-high",
        courtName: "Supreme Court of Minnesota",
        jurisdiction: "MN",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      or: {
        clCourtId: "or",
        nyayaCourtId: "st-or-high",
        courtName: "Oregon Supreme Court",
        jurisdiction: "OR",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      ri: {
        clCourtId: "ri",
        nyayaCourtId: "st-ri-high",
        courtName: "Supreme Court of Rhode Island",
        jurisdiction: "RI",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      wva: {
        clCourtId: "wva",
        nyayaCourtId: "st-wv-high",
        courtName: "West Virginia Supreme Court",
        jurisdiction: "WV",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      ariz: {
        clCourtId: "ariz",
        nyayaCourtId: "st-az-high",
        courtName: "Arizona Supreme Court",
        jurisdiction: "AZ",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
        ...
        target: 19,
        count: 0,
        nextAction: "case20_baseline"
      },
      colo: {
        clCourtId: "colo",
        nyayaCourtId: "st-co-high",
        courtName: "Supreme Court of Colorado",
        jurisdiction: "CO",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      conn: {
        clCourtId: "conn",
        nyayaCourtId: "st-ct-high",
        courtName: "Supreme Court of Connecticut",
        jurisdiction: "CT",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      ga: {
        clCourtId: "ga",
        nyayaCourtId: "st-ga-high",
        courtName: "Supreme Court of Georgia",
        jurisdiction: "GA",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      md: {
        clCourtId: "md",
        nyayaCourtId: "st-md-high",
        courtName: "Supreme Court of Maryland",
        jurisdiction: "MD",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      mich: {
        clCourtId: "mich",
        nyayaCourtId: "st-mi-high",
        courtName: "Michigan Supreme Court",
        jurisdiction: "MI",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      nc: {
        clCourtId: "nc",
        nyayaCourtId: "st-nc-high",
        courtName: "Supreme Court of North Carolina",
        jurisdiction: "NC",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      ohio: {
        clCourtId: "ohio",
        nyayaCourtId: "st-oh-high",
        courtName: "Ohio Supreme Court",
        jurisdiction: "OH",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
      ...
      wis: {
        clCourtId: "wis",
        nyayaCourtId: "st-wi-high",
        courtName: "Wisconsin Supreme Court",
        jurisdiction: "WI",
        courtLevel: "state_high",
        verificationStatus: "VERIFIED",
        ingestEnabled: true,
    ...
    function needsLiveVerification(entry) {
      ...
      if (entry.verificationStatus === "MAPPING_INVALID") return false;
    ...
    function applyVerificationResult(cache, clCourt, result, at = (/* @__PURE__ */ new Date()).toISOString()) {
      const key = String(clCourt).toLowerCase();
    ...
    function nationalHighReadiness(ids = [
      "la",
      "dc",
      "idaho",
      "mo",
...
// scripts/tmp-wave2ae-depth-manifest.cjs
var postgres = require_src();
var { REGISTRY } = require_cl_court_map_registry();
...
async function main() {
  ...
  try {
    ...
    const rows = perJur.map((r) => {
      ...
      const casesNeeded = deficit;
      const estReq = Math.ceil(casesNeeded * 2.3);
      const score = deficit * 10 + (mid === 0 && j !== "US" && j !== "DE" ? 200 : 0) + Math.min(targetAbsent, 500) * 0.05 + (100 - Number(r.currentness_pct || 0)) * 0.5;
      return {
        j,
        authorities: auth,
        ...
        reason: deficit >= 80 ? "largest authority deficit below gate" : mid === 0 && deficit > 0 ? "weak/absent intermediate appellate depth" : targetAbsent > 100 ? "citation TARGET_ABSENT demand" : "depth/breadth improvement"
      };
    });
