/**
 * Wave 2AC — paced single verify of remaining no-high national CL ids.
 * Candidates from Bluebook-style CL abbreviations (same pattern as prior waves).
 * ZERO speculative batch search; all through spacing + day/hour safety floor.
 * Do NOT cache VERIFIED unless HTTP 200.
 */
const CL_BASE = "https://www.courtlistener.com/api/rest/v4";
const CANDIDATES = [
  { cl: "ind", j: "IN", nyaya: "st-in-high", nameHint: "Indiana Supreme Court" },
  { cl: "me", j: "ME", nyaya: "st-me-high", nameHint: "Maine Supreme Judicial Court" },
  { cl: "minn", j: "MN", nyaya: "st-mn-high", nameHint: "Minnesota Supreme Court" },
  { cl: "or", j: "OR", nyaya: "st-or-high", nameHint: "Oregon Supreme Court" },
  { cl: "ri", j: "RI", nyaya: "st-ri-high", nameHint: "Rhode Island Supreme Court" },
  { cl: "wva", j: "WV", nyaya: "st-wv-high", nameHint: "West Virginia Supreme Court" },
];
