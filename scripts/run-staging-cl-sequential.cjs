...
const PLAN = [
  ...
  { court: "cafc", max: 12 },
  { court: "cal", max: 15 },
  { court: "calctapp", max: 12 },
  { court: "ny", max: 15 },
  { court: "nyappdiv", max: 12 },
  { court: "pa", max: 15 },
  { court: "pasuperct", max: 12 },
  { court: "tex", max: 15 },
  { court: "texapp", max: 12 },
  { court: "nj", max: 15 },
  { court: "njsuperct", max: 12 },
  { court: "fla", max: 15 },
  { court: "fladistctapp", max: 12 },
  { court: "ill", max: 15 },
  { court: "illappct", max: 12 },
  { court: "mass", max: 15 },
  { court: "massappct", max: 12 },
  { court: "va", max: 15 },
  { court: "vacapp", max: 12 },
  { court: "del", max: 12 },
];
